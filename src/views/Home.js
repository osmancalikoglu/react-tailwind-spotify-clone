...
const Home = () => {
  ...
  return (
    <div className="grid gap-y-8">
      <Section title="Recently played" more="/more1" items={items} />
      <Section title="Shows to try" more="/more2" items={items} />
      <Section title="Made for Osman Çalıkoğlu" more="/more2" items={items} />
    </div>
  );
};
